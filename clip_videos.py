...
def clip_trump_videos():
  ...
  for i in xrange(len(subclips)):
    clip = subclips[i]
    video_outfile = os.path.join(TRUMP_OUTPUT_CLIPPED_FOLDER, 'video', 'china-%03d.mp4' % i)
    audio_outfile = os.path.join(TRUMP_OUTPUT_CLIPPED_FOLDER, 'audio', 'china-%03d.m4a' % i)
...
if __name__ == '__main__':
  clip_trump_videos()
  plotstft('./data/clipped/trump/audio/china-100.m4a')
